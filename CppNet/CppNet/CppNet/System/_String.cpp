...
namespace CppNet
{
	namespace System
	{
		...
		_String::_String(Char* chars, size_t start, size_t length)
		{
		...
		_String::_String(Char chr, size_t length)
		{
		...
		_String::_String(const char* chars, size_t start, size_t length)
		{
